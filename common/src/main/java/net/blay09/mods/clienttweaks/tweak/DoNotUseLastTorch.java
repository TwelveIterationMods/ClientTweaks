...
public class DoNotUseLastTorch extends AbstractClientTweak {
    ...
    public DoNotUseLastTorch() {
        ...
        ClientItemCallback.Use.EVENT.register(EventPhases.LOWEST, this::onRightClick);
    }
    ...
    public void setEnabled(boolean enabled) {
        Balm.config().updateLocalConfig(ClientTweaksConfig.class, it -> it.torches.doNotUseLastTorch = enabled);
    }
